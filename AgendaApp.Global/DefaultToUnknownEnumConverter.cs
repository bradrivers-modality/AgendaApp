...
{
    public class DefaultToUnknownEnumConverter : StringEnumConverter
    {
        /// <summary>
        ...
        /// </summary>
        public DefaultToUnknownEnumConverter()
        { }
        ...
        public DefaultToUnknownEnumConverter(int defaultValue)
        {
